...
El programa, al recibir como dato de un arreglo unidimensional desordenado de N
elementos, obtiene como salida ese mismo arreglo pero sin los elementos repetidos. */

void Lectura(int *, int);   /* Prototipos de funciones. */
void Imprime(int *, int);
void Elimina(int *, int *);
/*Observa que el prototipo de Elimina, el segundo parametro es por referencia.
...
/* La funcion Lectura se utiliza para leer un arreglo unidimensional de elementos de T
