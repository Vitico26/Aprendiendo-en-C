void  restarMatrices(int matriz1[][3], int matriz2[][3], int resultado[][3]) {  //Se declaran las funcion resta y el tamaño de cada matriz
...
int main() {
    ...
    restarMatrices(matriz1, matriz2, resultado);                                 //Se le hace un llamdo a la funcion suma y mencionando las matrices 1, 2 y la resultante
